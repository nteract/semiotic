...
async function main() {
  ...
  // Type the checked-in fixtures against the adapter's local structural mirror
  // of the DisplayList schema (`GofishDisplayListDocument` in gofishIR.ts), not
  // against gofish-ir. gofish-ir is a devDependency used only to *bake* these
