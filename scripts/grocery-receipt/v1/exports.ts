// Original-edition presentation, pinned from 490302b8.
// Keep live/v2 presentation changes in docs; this source reproduces immutable v1 artifacts.
import { monthName, money, percent, signedMoney, summary } from "../../../docs/src/pages/examples/grocery-receipt/format"
import { QUALIFICATION, STORY_URL } from "../../../docs/src/pages/examples/grocery-receipt/items"
import { receiptSearch } from "../../../docs/src/pages/examples/grocery-receipt/state"
import type { GrocerySnapshot, PreparedBasket } from "../../../docs/src/pages/examples/grocery-receipt/types"
