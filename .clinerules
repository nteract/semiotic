...
- **Use sub-path imports** — `semiotic/xy` (91KB gz), `semiotic/ordinal` (75KB gz), `semiotic/network` (70KB gz), `semiotic/geo` (56KB gz), `semiotic/realtime` (100KB gz), `semiotic/server` (129KB gz), `semiotic/utils` (39KB gz), `semiotic/recipes` (11KB gz), `semiotic/themes` (4KB gz), `semiotic/data` (3KB gz), `semiotic/value` (6KB gz), `semiotic/ai` (256KB gz). Full `semiotic` is 207KB gz.
