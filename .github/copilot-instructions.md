...
- **Use sub-path imports** — `semiotic/xy` (216KB gz), `semiotic/ordinal` (168KB gz), `semiotic/network` (156KB gz), `semiotic/geo` (121KB gz), `semiotic/realtime` (216KB gz), `semiotic/server` (281KB gz), `semiotic/utils` (40KB gz), `semiotic/recipes` (14KB gz), `semiotic/themes` (7KB gz), `semiotic/data` (6KB gz), `semiotic/ai` (441KB gz). Full `semiotic` is 443KB gz.
