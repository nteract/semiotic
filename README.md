...
|---|---|---|
| `semiotic/xy` | **102 KB** | LineChart, AreaChart, Scatterplot, Heatmap, + 8 more XY charts |
| `semiotic/ordinal` | **83 KB** | BarChart, PieChart, BoxPlot, Histogram, + 11 more categorical charts |
...
| `semiotic/server` | **186 KB** | renderChart, renderDashboard, renderToImage, renderToAnimatedGif |
| `semiotic/utils` | **60 KB** | ThemeProvider, validators, serialization — no chart components |
| `semiotic/recipes` | **50 KB** | Pure layout functions (waffle, marimekko, flextree, dagre, …) |
...
| `semiotic/physics` | **85 KB** | GaltonBoardChart, EventDropChart, PhysicsPileChart, CollisionSwarmChart, PhysicalFlowChart, PhysicsCustomChart |
...
| `semiotic/ai` | **385 KB** | All schema-backed charts + validation — optimized for LLM code generation |
| `semiotic` | **296 KB** | Everything below (full bundle) |
