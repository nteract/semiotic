...
| `semiotic/ai` | **540 KB** | All schema-backed charts + validation — optimized for LLM code generation |
...
| `semiotic` | **352 KB** | Everything below (full bundle) |
...
|---|---:|---:|
| `import { LineChart } from "semiotic"` | browser | **138.7 KiB** |
| `import { LineChart } from "semiotic/xy"` | browser | **139.2 KiB** |
| `import { LineChart } from "semiotic/line"` | browser | **139.0 KiB** |
| `import { BarChart } from "semiotic/ordinal"` | browser | **131.5 KiB** |
| `import { SankeyDiagram } from "semiotic/network"` | browser | **156.1 KiB** |
| `import { RealtimeLineChart } from "semiotic/realtime"` | browser | **138.5 KiB** |
