...
|---|---|---|
| `semiotic/xy` | **157 KB** | LineChart, AreaChart, Scatterplot, Heatmap, + 8 more XY charts |
...
| `semiotic/realtime/core` | **151 KB** | Streaming chart types, HOCs, and buffer helpers |
...
| `semiotic/ai` | **531 KB** | All schema-backed charts + validation — optimized for LLM code generation |
| `semiotic/ai/core` | **89 KB** | suggestCharts, auditData, describeChart, repairChartConfig, tool adapters — no chart components |
...
| `semiotic` | **343 KB** | Everything below (full bundle) |
...
|---|---:|---:|
| `import { LineChart } from "semiotic"` | browser | **165.3 KiB** |
| `import { LineChart } from "semiotic/xy"` | browser | **165.2 KiB** |
| `import { BarChart } from "semiotic/ordinal"` | browser | **131.6 KiB** |
| `import { SankeyDiagram } from "semiotic/network"` | browser | **155.0 KiB** |
| `import { RealtimeLineChart } from "semiotic/realtime"` | browser | **135.7 KiB** |
...
| `import { renderChart } from "semiotic/server"` | node | **251.2 KiB** |
| `import { generateFrameSVGs } from "semiotic/server/edge"` | node | **117.5 KiB** |
| `import { renderToImage } from "semiotic/server/node"` | node | **251.6 KiB** |
| `import { suggestCharts } from "semiotic/ai"` | browser | **242.8 KiB** |
| `import { suggestCharts } from "semiotic/ai/core"` | browser | **38.6 KiB** |
| `import { bin } from "semiotic/data"` | browser | **0.4 KiB** |
| `import { ChoroplethMap } from "semiotic/geo"` | browser | **115.1 KiB** |
