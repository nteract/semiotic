...
| `semiotic/utils` | **33 KB** | ThemeProvider, validators, serialization — no chart components |
...
| `semiotic/ai` | **235 KB** | All 42 HOCs + validation — optimized for LLM code generation |
| `semiotic` | **195 KB** | Everything below (full bundle) |
