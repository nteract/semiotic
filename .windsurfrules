...
- **Use sub-path imports** — `semiotic/xy` (102KB gz), `semiotic/ordinal` (83KB gz), `semiotic/network` (88KB gz), `semiotic/geo` (64KB gz), `semiotic/realtime` (111KB gz), `semiotic/server` (138KB gz), `semiotic/utils` (52KB gz), `semiotic/recipes` (38KB gz), `semiotic/themes` (6KB gz), `semiotic/data` (4KB gz), `semiotic/value` (6KB gz), `semiotic/ai` (318KB gz). Full `semiotic` is 245KB gz.
