...
class-member HyperLogLog::construct::%24construct = required new (p?: number | undefined): HyperLogLog
class-member HyperLogLog::method::add = required add(value: number | string): void
class-member HyperLogLog::method::clone = required clone(): HyperLogLog
class-member HyperLogLog::method::count = required count(): number
class-member HyperLogLog::method::merge = required merge(other: HyperLogLog): void
...
class-member TDigest::construct::%24construct = required new (compression?: number | undefined): TDigest
class-member TDigest::get::count = get count: number
class-member TDigest::method::clone = required clone(): TDigest
class-member TDigest::method::merge = required merge(other: TDigest): void
class-member TDigest::method::push = required push(value: number): void
class-member TDigest::method::quantile = required quantile(q: number): number
...
function applyChangelog<T extends Datum = Datum>(handle: Pick<RealtimeFrameHandle<T, T>, "getData" | "push" | "pushMany" | "remove" | "update">, events: readonly ChangelogOp<T>[], options: ApplyChangelogOptions<T>): ApplyChangelogResult
...
interface ApplyChangelogOptions<T extends Datum = Datum>
interface ApplyChangelogResult
interface BarStyle
...
interface-member AggregatedWindow::property::distinct = optional distinct: number | undefined
...
interface-member AggregatedWindow::property::percentiles = optional percentiles: Readonly<Record<string, number>> | undefined
...
interface-member ApplyChangelogOptions::property::coalesce = optional coalesce: boolean | undefined
interface-member ApplyChangelogOptions::property::key = required key: ((row: T) => string) | string
interface-member ApplyChangelogResult::property::applied = required applied: number
interface-member ApplyChangelogResult::property::retracts = required retracts: number
interface-member ApplyChangelogResult::property::upserts = required upserts: number
...
interface-member DecayConfig::property::type = required type: "exponential" | "linear" | "step"
...
interface-member PulseConfig::property::duration = optional duration: number | undefined
interface-member PulseConfig::property::glowRadius = optional glowRadius: number | undefined
...
interface-member StalenessConfig::property::badgePosition = optional badgePosition: "bottom-left" | "bottom-right" | "top-left" | "top-right" | undefined
interface-member StalenessConfig::property::dimOpacity = optional dimOpacity: number | undefined
interface-member StalenessConfig::property::graded = optional graded: boolean | undefined | {thresholds?: import("../realtime/lifecycleBands").LifecycleBandThresholds; opacities?: Partial<Record<import("../realtime/lifecycleBands").LifecycleBand, number>>;}
interface-member StalenessConfig::property::settling = optional settling: boolean | undefined
interface-member StalenessConfig::property::showBadge = optional showBadge: boolean | undefined
interface-member StalenessConfig::property::state = optional state: SourceLiveness | undefined
interface-member StalenessConfig::property::threshold = optional threshold: number | undefined
...
interface-member WindowAccumulatorConfig::property::distinct = optional distinct: boolean | undefined
...
interface-member WindowAccumulatorConfig::property::percentiles = optional percentiles: readonly number[] | undefined
