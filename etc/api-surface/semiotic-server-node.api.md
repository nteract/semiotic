# semiotic-server-node public API surface

_Auto-generated by `scripts/generate-api-surface.mjs` from `dist/semiotic-server-node.d.ts`._
_Edit dist/semiotic-server-node.d.ts's sources, then re-run `npm run docs:api-surface` to refresh._
...
interface-member RenderEvidence::property::sceneHash = optional sceneHash: string | undefined
interface-member RenderEvidence::property::sceneHashVersion = optional sceneHashVersion: 2 | undefined
