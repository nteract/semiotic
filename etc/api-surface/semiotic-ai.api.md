...
function TooltipProvider(props: import("semiotic-internal/components/store/createStore").StoreProviderProps<TooltipStoreState>): Promise<import("react").ReactNode> | import("react").ReactNode
