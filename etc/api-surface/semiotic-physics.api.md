...
interface-member CollisionSwarmProjectionMetadata::property::groups = required groups: {label: string; y: number; count: number; overlapping?: boolean;}[]
...
interface-member PhysicsBodySpec::property::fixedPosition = optional fixedPosition: undefined | {x?: number; y?: number;}
...
interface-member PhysicsBodyState::property::fixedPosition = optional fixedPosition: undefined | {x?: number; y?: number;}
