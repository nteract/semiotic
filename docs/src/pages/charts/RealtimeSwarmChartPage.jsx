...
const realtimeSwarmChartProps = [
  ...
  { name: "yScaleType", type: '"linear" | "log" | "symlog"', required: false, default: '"linear"', description: "Value-axis scale. symlog supports signed values while compressing large magnitudes." },
  ...
  { name: "cursor", type: "CSS cursor", required: false, default: null, description: 'Presentation-only default cursor for dots, such as "pointer". It does not add click or keyboard behavior.' },
  { name: "pointStyle", type: "function", required: false, default: null, description: "Per-datum dot style callback. Returned fill, stroke, strokeWidth, opacity, cursor, and r values override chart defaults." },
  ...
  { name: "showLegend", type: "boolean", required: false, default: "false", description: "Show the categorical legend. RealtimeSwarmChart keeps its historical opt-in default." },
  { name: "legendPosition", type: '"right" | "left" | "top" | "bottom"', required: false, default: '"right"', description: "Categorical legend position." },
  { name: "legendInteraction", type: '"highlight" | "isolate" | "none"', required: false, default: null, description: "Highlight or isolate marks from inferred category legend items." },
...
/>`}
      ...
      <p>
        Use <Link to="/frames/realtime-frame">StreamXYFrame</Link> directly for threshold coloring,
        combined chart types, or custom canvas marks. <code>RealtimeSwarmChart</code> delegates to
        a configured <code>StreamXYFrame</code>.
      </p>
