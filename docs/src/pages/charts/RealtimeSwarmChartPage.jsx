...
const realtimeSwarmChartProps = [
  ...
  { name: "pointStyle", type: "function", required: false, default: null, description: "Per-datum dot style callback. Returned fill, stroke, strokeWidth, opacity, and r values override chart defaults." },
