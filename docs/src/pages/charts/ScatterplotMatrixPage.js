...
const splomProps = [
  ...
  { name: "onClick", type: "function", required: false, default: null, description: "Called when a point in any cell is clicked. Receives the clicked row datum and its grid-relative pixel position { x, y }. Works in both hover and brush modes." },
  { name: "onObservation", type: "function", required: false, default: null, description: "Called with { type, datum, x, y, ... } on hover, hover-end, and click. Use to drive coordinated views from matrix interactions." },
...
export default function ScatterplotMatrixPage() {
  ...
  // ...60 data points
      ...
      <p>
        ...
        clicked row datum and its grid-relative pixel position, in both hover
        and brush modes -- no container <code>onClick</code> wrapper or hover
        tracking required. The{" "}
