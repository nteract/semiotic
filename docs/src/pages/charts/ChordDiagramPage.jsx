...
const chordDiagramProps = [
  ...
  { name: "showLegend", type: "boolean", required: false, default: "true (when colorBy set)", description: "Show a categorical legend for colorBy." },
  { name: "legendPosition", type: '"right" | "left" | "top" | "bottom"', required: false, default: '"right"', description: "Position the legend around the plot." },
  { name: "legendInteraction", type: '"highlight" | "isolate" | "none"', required: false, default: '"none"', description: "Highlight or isolate categories from the legend." },
...
export default function ChordDiagramPage() {
  return (
    ...
    >
      ...
      {/* Quick Start */}
      {/* ----------------------------------------------------------------- */}
      <ChartGrounding component="ChordDiagram" />
