...
export default function ViolinPlotPage() {
  return (
    ...
    >
      ...
      {/* Quick Start */}
      {/* ----------------------------------------------------------------- */}
      <ChartGrounding component="ViolinPlot" />
...
<ViolinPlot data={data} brush onBrush={setExtent} height={160} />
