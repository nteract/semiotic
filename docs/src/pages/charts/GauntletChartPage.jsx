...
const gauntletChartProps = [
  ...
  { name: "startTimeAccessor", type: "string | function", required: false, default: "0", description: "Returns the simulation second when each project's local event timeline begins." },
  { name: "positiveProperties", type: "array", required: false, default: "[]", description: "Optional definitions for lift, value, color, radius, spring, and custom target behavior. Omit or pass an empty array for negative-only compound bodies." },
  ...
  { name: "gates", type: "array", required: false, default: "[]", description: "Named regions along the route. Gates can contribute a regionEffect and optional shared FIFO capacity." },
  ...
  { name: "rerunMS", type: "number | null", required: false, default: null, description: "Replay the full compound simulation this many milliseconds after it settles; zero replays on the next timer turn." },
  { name: "showChrome", type: "boolean", required: false, default: "true", description: "Draw the default route, gates, crash line, socket, and graveyard decoration." },
