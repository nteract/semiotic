...
const unitPileChartProps = [
  ...
  { name: "valueAccessor", type: "string | function", required: false, default: null, description: "Nonnegative numeric field converted into units. Omit to count each row as 1; mechanical mode defaults to value." },
  ...
  { name: "unitValue", type: "number", required: false, default: "1", description: "Value per full circle. A record's remainder uses a partial circle scaled by area." },
  { name: "ballRadius", type: "number", required: false, default: "8", description: "Radius of a full unit circle. Remainder circles scale by area." },
  ...
  { name: "showProjection", type: "boolean", required: false, default: "true", description: "Label exact source category totals and show approximate stacking guides." },
...
export default function UnitPileChartPage() {
  ...
  return (
    ...
    >
      ...
      <p>
        Each full circle represents <code>unitValue</code>. A record's remainder becomes a
        smaller circle whose area represents its share of a unit. Labels show exact source
