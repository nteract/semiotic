...
import auditedRiverDataset from "../../../../strategy/united_states_history_river_dataset.json"
import {
  attachmentYRange,
...
describe("United States persistent-process adapter", () => {
  it("keeps the compact browser projection in parity with the audited strategy dataset", () => {
