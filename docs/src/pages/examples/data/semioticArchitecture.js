...
export const SEMIOTIC_ARCHITECTURE_NODES = [
  ...
  {
    id: "hoc-chain-reaction",
    label: "ChainReactionChart",
    detail:
      "Dependency machines where completed tasks deliver prerequisite tokens and blockers expose downstream reach.",
    layer: "leaf",
    cluster: "physics",
    parent: "frame-physics",
    order: 8,
  ...
  },
  {
    ...
    detail:
      "Foreground/background graphics and recipe decoration layer bespoke marks over a frame.",
    layer: "fruit",
    parent: "feature-bough",
    order: 7,
  },
...
const EXPLICIT_EXAMPLE_PROFILES = [
  ...
  },
  {
    ...
    shortLabel: "Bad Chart Autopsy",
    note: "A five-row benchmark case makes rendering, deception, accessibility, and repair separate inspectable verdicts: the suspect BarChart paints every mark but is rejected, while the unchanged data earns release through a DotPlot whose labeled comparison window uses position rather than false bar magnitude.",
    uses: [
      "input-static",
      "hoc-bar",
      "feature-accessors",
  ...
  },
  {
    ...
    shortLabel: "Last Scarcity",
    note: "A nine-chapter interactive essay coordinates historical replay, a circular counterfactual day, a before/after scarcity ProcessSankey, a three-beat court network, a promise-vs-association DifferenceChart, a constitution field, and an opt-in local reading mirror through one evolving Palace state.",
    uses: [
      "input-static",
      "input-push",
      "hoc-realtime-line",
  ...
  },
  {
    ...
    shortLabel: "Hellhole Changed Addresses",
    note: "A source-cited scrollytelling essay stages America appointing the city as hellhole and then transferring the curse to suburbia, while real material conditions, resident preferences, paired Census FlowMaps, and birth-year observers complicate the handoff without surrendering the thesis.",
    uses: [
      "input-static",
      "hoc-geo-movement",
      "hoc-xy-custom",
  ...
  },
  {
    ...
    shortLabel: "Parataxis Machine",
    note: "An interactive explainer coordinates a custom clause constellation, an editorial ambiguity heatmap, a compression-versus-evidence quadrant, style-comparison bars, and a bounded sentence generator through shared reader state.",
    uses: [
      "input-static",
      "hoc-network-custom",
      "hoc-xy-points",
  ...
  },
  {
    ...
    shortLabel: "Apollo: The Third Seat",
    note: "A source-audited ProcessSankey aligns nine NASA Ground Elapsed Time chronologies at launch, conserving crew-seats through lunar-orbit splits, surface stays, reunion, Apollo 10’s low pass, Apollo 13’s lifeboat, and recovery.",
    uses: [
      "input-static",
      "hoc-network-flow",
      "feature-accessors",
  ...
  },
  {
    ...
    shortLabel: "The 7,197-Vote Corridor",
    note: "A certified ranked-choice ledger conserves 942,031 ballots through three elimination pools, exposing how Garcia closed 96,725 votes of Adams’s Round 5 lead while inactive ballots accumulated.",
    uses: [
      "input-static",
      "hoc-network-flow",
      "feature-accessors",
  ...
  },
  {
    ...
    shortLabel: "Germany, Still Becoming",
    note: "A source-audited vertical ProcessSankey carries 26 fixed contributions to modern Germany through 12 historical openings, conserving width while regional containers split, merge, disappear, and return; incompatible external gains and losses remain explicitly outside the core scale.",
    uses: [
      "input-static",
      "hoc-network-flow",
      "feature-accessors",
  ...
  },
  {
    ...
    shortLabel: "Good Earth → Lying Flat",
    note: "A vertical ProcessSankey makes an explicitly interpretive six-stage causal argument: inherited insecurity becomes security strategies, growth machinery, broken promises, adaptive responses, and social outcomes. Claim lenses and mixed-color HatchFill nodes preserve the diagram's analytical uncertainty and contested links.",
    uses: [
      "input-static",
      "hoc-network-flow",
      "feature-accessors",
  ...
  },
  {
    ...
    shortLabel: "The United States, Drawn Together",
    note: "A source-audited vertical ProcessSankey compiles 64 dated transactions around three persistent institutional inventories: acquisitions feed States, Territories, and an explicitly analytical Colonies band; statehood transfers routes, Civil War removes and restores them, and Cuba, the Philippines, Pacific trusts, and canal control leave through lifecycle fades.",
    uses: [
      "input-static",
      "hoc-network-flow",
      "feature-accessors",
  ...
  {
    id: "data-viz-for-dummies-2",
    shortLabel: "Data Viz for Dummies II",
    note: "A fictional arena sends in seven chart specialists: StackedBarChart, AreaChart, BoxPlot, Heatmap, FunnelChart, ChordDiagram, and ForceDirectedGraph explain composition, volume, comparative spread, matrices, attrition, reciprocal exchange, and topology.",
    uses: [
      "input-static",
      "hoc-ordinal-bars",
      "hoc-ordinal-distribution",
  ...
  {
    id: "data-viz-for-dummies-3",
    shortLabel: "Data Viz for Dummies III",
    note: "A chart-substitution lab compares seven challengers with familiar starters: DotPlot, ViolinPlot, RidgelinePlot, DifferenceChart, ConnectedScatterplot, TreeDiagram, and CirclePack preserve ranking, density, difference, sequence, ancestry, and nested magnitude in different ways.",
    uses: [
      "input-static",
      "hoc-ordinal-bars",
      "hoc-ordinal-distribution",
  ...
  {
    id: "data-viz-for-dummies-4",
    shortLabel: "Data Viz for Dummies IV",
    note: "Seven specialist rotations complete the core chart roster with PieChart, DonutChart, GaugeChart, LikertChart, SwarmPlot, BubbleChart, QuadrantChart, ScatterplotMatrix, StackedAreaChart, MultiAxisLineChart, CandlestickChart, SwimlaneChart, MinimapChart, OrbitDiagram, and ProcessSankey.",
    uses: [
      "input-static",
      "hoc-ordinal-distribution",
      "hoc-xy-lines",
  ...
  {
    id: "data-viz-for-dummies-5",
    shortLabel: "Data Viz for Dummies V",
    note: "A fictional road season explains six geographic contracts through ChoroplethMap, ProportionalSymbolMap, FlowMap, DistanceCartogram, tiled map context, and GeoCustomChart.",
    uses: [
      "input-static",
      "hoc-geo-reference",
      "hoc-geo-movement",
