...
const EXPLICIT_EXAMPLE_PROFILES = [
  ...
  },
  {
    ...
    note: "An IntersectionObserver-led AI-age argument uses a pinned DHQ corpus and public repository evidence across a custom history spiral, editorial Sankey, authorship line, controlled-tag bars, physics metadata clock, interactive classification flow, recommendation-route author network, and overlap swarm.",
    uses: [
      "input-static",
      "hoc-xy-custom",
      "hoc-network-flow",
