...
const EXPLICIT_EXAMPLE_PROFILES = [
  ...
  {
    id: "miles-are-a-lie",
    shortLabel: "Miles Are a Lie",
    note: "A DistanceCartogram warps metro destinations by composed lived-cost friction from semiotic/recipes, while BarChart styleRules+hatch, LineChart stretch history, BigNumber tiles, and aging alert annotations share one cost ledger.",
    uses: [
      "input-static",
      "hoc-geo-movement",
      "hoc-xy-lines",
  ...
  },
  {
    ...
    note: "intervalLanesLayout shows the same City Pulse tasks as a schedule; ChainReactionChart re-plots them by dependency depth so two 90% blockers reveal unequal amplification.",
    uses: [
      "input-static",
      "hoc-ordinal-custom",
      "frame-physics",
  ...
  {
    id: "yellowstone-mobile",
    shortLabel: "Yellowstone Mobile",
    note: "A NetworkCustomChart with habitat-fixed plates, unitize ISOTYPE tallies, and signed lagged edges teaches multi-hop cascade literacy — deliberately omitting any wolf→river wire.",
    uses: [
      "input-static",
      "hoc-network-custom",
      "hoc-ordinal-bars",
