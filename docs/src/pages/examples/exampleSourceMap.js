const SOURCE_LOADERS_BY_PATH = {
  ...
  "/examples/plinko-quantile-dotplot": () =>
    import("./PlinkoQuantileDotplotExamplePage.jsx?raw").then((module) => module.default),
  "/examples/queue-weather": () =>
    import("./QueueWeatherExamplePage.jsx?raw").then((module) => module.default),
