...
const controls = [
  { name: "colorByDepth", type: "boolean", label: "Color by Depth", group: "Color",
    default: false },
  { name: "circleOpacity", type: "number", label: "Circle Opacity", group: "Style",
...
// ---------------------------------------------------------------------------
// Datasets (same hierarchical structures as Treemap)
// ---------------------------------------------------------------------------
...
export default function CirclePackPlayground() {
  return (
    <PlaygroundLayout
      title="Circle Pack Playground"
      breadcrumbs={[
        { label: "Playground", path: "/playground" },
        { label: "Circle Pack", path: "/playground/circle-pack" },
      ]}
      prevPage={{ title: "Treemap Playground", path: "/playground/treemap" }}
      nextPage={null}
      chartComponent={CirclePack}
    ...
    >
      <p>
        Experiment with CirclePack props in real time. Circle packing represents
        hierarchical data as nested circles, where each circle's area corresponds
        to its value. Compared to treemaps, circle packs use space less
        efficiently but make containment relationships easier to perceive. Adjust
        opacity and toggle color-by-depth to highlight the hierarchy.
      </p>
    </PlaygroundLayout>
  )
}
