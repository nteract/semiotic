  ...
  return (
    <PageLayout
      ...
      breadcrumbs={[
        ...
        { label: "Vega-Lite Translator", path: "/interoperability/vega-lite" },
      ]}
      prevPage={{ title: "Portability Spec", path: "/interoperability/portability-spec" }}
      nextPage={{ title: "Observable Plot", path: "/interoperability/observable-plot" }}
    >
      {/* ── Why ────────────────────────────────────────────────────────── */}
      <section>
        <h2>Why</h2>
