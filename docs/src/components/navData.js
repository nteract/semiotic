const navData = [
    ...
    children: [
      {
        ...
        children: [
          ...
          { title: "Waterfall Chart", path: "/charts/waterfall-chart" },
      ...
      },
      {
        ...
        children: [
          ...
          { title: "Radar Chart", path: "/charts/radar-chart" },
      ...
      },
      {
        ...
        children: [
          ...
          { title: "Unit Pile Chart", path: "/charts/unit-pile-chart" },
          { title: "Collision Swarm Chart", path: "/charts/collision-swarm-chart" },
          { title: "Packet Flow Chart", path: "/charts/packet-flow-chart" },
          { title: "Flow Circuit", path: "/charts/flow-circuit-chart" },
          ...
          { title: "Chain Reaction Chart", path: "/charts/chain-reaction-chart" },
  ...
  },
  {
    ...
    children: [
      ...
      { title: "The Release Machine", path: "/examples/chain-reaction" },
      ...
      { title: "Data Viz for Dummies II", path: "/examples/data-viz-for-dummies-2" },
      { title: "Data Viz for Dummies III", path: "/examples/data-viz-for-dummies-3" },
      { title: "Data Viz for Dummies IV", path: "/examples/data-viz-for-dummies-4" },
      { title: "Data Viz for Dummies V", path: "/examples/data-viz-for-dummies-5" },
      { title: "Data Viz for Dummies VI", path: "/examples/data-viz-for-dummies-6" },
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Geographic Grid Maps", path: "/recipes/geographic-grid-maps" },
