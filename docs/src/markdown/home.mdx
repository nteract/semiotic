...
Semiotic offers several frame types to deploy a wide variety of charts. These
frame types:
...
provide the foundation for rich visualizations and highly customizable charts.
