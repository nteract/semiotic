...
const quickStartSteps = [
  {
    number: 1,
    title: "Install",
    code: "npm install semiotic@3.0.0-beta.6"
  },
  {
    number: 2,
    title: "Import",
      ...
      <section style={styles.hero}>
        <div style={styles.heroInner}>
          ...
          <div style={styles.installBlock}>
            <code style={styles.installText}>npm install semiotic@3.0.0-beta.6</code>
            <CopyButton text="npm install semiotic@3.0.0-beta.6" style={styles.installCopy} />
          </div>
