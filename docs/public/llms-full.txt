...
- **Use sub-path imports** — `semiotic/xy` (87KB gz), `semiotic/ordinal` (71KB gz), `semiotic/network` (64KB gz), `semiotic/geo` (52KB gz), `semiotic/realtime` (92KB gz), `semiotic/server` (123KB gz), `semiotic/utils` (36KB gz), `semiotic/recipes` (5KB gz), `semiotic/themes` (4KB gz), `semiotic/data` (3KB gz), `semiotic/value` (6KB gz), `semiotic/ai` (239KB gz). Full `semiotic` is 198KB gz.
