...
- **Use sub-path imports** — `semiotic/xy` (100KB gz), `semiotic/ordinal` (80KB gz), `semiotic/network` (85KB gz), `semiotic/geo` (62KB gz), `semiotic/realtime` (109KB gz), `semiotic/server` (136KB gz), `semiotic/utils` (39KB gz), `semiotic/recipes` (35KB gz), `semiotic/themes` (6KB gz), `semiotic/data` (4KB gz), `semiotic/value` (6KB gz), `semiotic/ai` (275KB gz). Full `semiotic` is 226KB gz.
