# plane-day: reading revision 2

This presentation revision uses the unchanged source edition ha-2025-07-74309a3a734d-v1. The original edition's raw files and downloads remain available. This adapter accepts the current story state and generates its expanded self-contained HTML.
