...
**Use sub-path imports** — `semiotic/xy` (106KB gz), `semiotic/ordinal` (86KB gz), `semiotic/network` (91KB gz), `semiotic/geo` (64KB gz), `semiotic/realtime` (117KB gz), `semiotic/realtime/core` (117KB gz), `semiotic/realtime/react` (1KB gz), `semiotic/server` (121KB gz), `semiotic/server/node` (121KB gz), `semiotic/server/edge` (120KB gz), `semiotic/utils` (58KB gz), `semiotic/utils/core` (57KB gz), `semiotic/utils/react` (4KB gz), `semiotic/recipes` (53KB gz), `semiotic/recipes/core` (52KB gz), `semiotic/recipes/react` (1KB gz), `semiotic/themes` (6KB gz), `semiotic/themes/core` (6KB gz), `semiotic/themes/react` (4KB gz), `semiotic/data` (3KB gz), `semiotic/value` (6KB gz), `semiotic/physics` (102KB gz), `semiotic/physics/matter` (1KB gz), `semiotic/physics/rapier` (1KB gz), `semiotic/ai` (391KB gz), `semiotic/ai/core` (66KB gz), `semiotic/controls` (10KB gz), `semiotic/rough` (3KB gz). Full `semiotic` is 248KB gz.
