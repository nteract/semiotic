...
**Use sub-path imports** — `semiotic/xy` (91KB gz), `semiotic/ordinal` (76KB gz), `semiotic/network` (71KB gz), `semiotic/geo` (56KB gz), `semiotic/realtime` (101KB gz), `semiotic/server` (129KB gz), `semiotic/utils` (39KB gz), `semiotic/recipes` (13KB gz), `semiotic/themes` (6KB gz), `semiotic/data` (4KB gz), `semiotic/value` (6KB gz), `semiotic/ai` (261KB gz). Full `semiotic` is 209KB gz.
