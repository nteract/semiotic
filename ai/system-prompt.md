...
- **Tooltip behavior needs browser evidence** (`interaction.tooltip-content-and-verification`): Interactive charts keep useful tooltips unless omission is intentional. tooltip=false or a null callback result suppresses the entire tooltip, independently of hover observations and selection. Verify actual content and placement in a browser; do not silently disable tooltips to avoid a defect.
