...
**Use sub-path imports** — `semiotic/xy` (99KB gz), `semiotic/ordinal` (81KB gz), `semiotic/network` (85KB gz), `semiotic/geo` (62KB gz), `semiotic/realtime` (109KB gz), `semiotic/realtime/core` (108KB gz), `semiotic/realtime/react` (1KB gz), `semiotic/server` (185KB gz), `semiotic/server/node` (185KB gz), `semiotic/server/edge` (185KB gz), `semiotic/utils` (71KB gz), `semiotic/utils/core` (70KB gz), `semiotic/utils/react` (4KB gz), `semiotic/recipes` (53KB gz), `semiotic/recipes/core` (52KB gz), `semiotic/recipes/react` (1KB gz), `semiotic/themes` (6KB gz), `semiotic/themes/core` (6KB gz), `semiotic/themes/react` (4KB gz), `semiotic/data` (3KB gz), `semiotic/value` (6KB gz), `semiotic/physics` (97KB gz), `semiotic/physics/matter` (1KB gz), `semiotic/physics/rapier` (1KB gz), `semiotic/ai` (389KB gz), `semiotic/ai/core` (77KB gz). Full `semiotic` is 253KB gz.
