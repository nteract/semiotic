...
**Use sub-path imports** — `semiotic/xy` (104KB gz), `semiotic/ordinal` (85KB gz), `semiotic/network` (89KB gz), `semiotic/geo` (62KB gz), `semiotic/realtime` (115KB gz), `semiotic/realtime/core` (114KB gz), `semiotic/realtime/react` (1KB gz), `semiotic/server` (121KB gz), `semiotic/server/node` (121KB gz), `semiotic/server/edge` (120KB gz), `semiotic/utils` (58KB gz), `semiotic/utils/core` (57KB gz), `semiotic/utils/react` (4KB gz), `semiotic/recipes` (53KB gz), `semiotic/recipes/core` (52KB gz), `semiotic/recipes/react` (1KB gz), `semiotic/themes` (6KB gz), `semiotic/themes/core` (6KB gz), `semiotic/themes/react` (4KB gz), `semiotic/data` (3KB gz), `semiotic/value` (6KB gz), `semiotic/physics` (101KB gz), `semiotic/physics/matter` (1KB gz), `semiotic/physics/rapier` (1KB gz), `semiotic/ai` (388KB gz), `semiotic/ai/core` (66KB gz), `semiotic/controls` (5KB gz). Full `semiotic` is 245KB gz.
