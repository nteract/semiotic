...
**Use sub-path imports** — `semiotic/xy` (97KB gz), `semiotic/ordinal` (79KB gz), `semiotic/network` (84KB gz), `semiotic/geo` (61KB gz), `semiotic/realtime` (105KB gz), `semiotic/server` (176KB gz), `semiotic/utils` (58KB gz), `semiotic/recipes` (46KB gz), `semiotic/themes` (6KB gz), `semiotic/data` (3KB gz), `semiotic/value` (6KB gz), `semiotic/physics` (79KB gz), `semiotic/physics/matter` (1KB gz), `semiotic/physics/rapier` (1KB gz), `semiotic/ai` (367KB gz). Full `semiotic` is 235KB gz.
