...
**Use sub-path imports** — `semiotic/xy` (95KB gz), `semiotic/ordinal` (77KB gz), `semiotic/network` (71KB gz), `semiotic/geo` (57KB gz), `semiotic/realtime` (101KB gz), `semiotic/server` (130KB gz), `semiotic/utils` (39KB gz), `semiotic/recipes` (13KB gz), `semiotic/themes` (6KB gz), `semiotic/data` (4KB gz), `semiotic/value` (6KB gz), `semiotic/ai` (265KB gz). Full `semiotic` is 212KB gz.
