...
**Use sub-path imports** — `semiotic/xy` (81KB gz), `semiotic/ordinal` (66KB gz), `semiotic/network` (62KB gz), `semiotic/geo` (50KB gz), `semiotic/realtime` (88KB gz), `semiotic/server` (73KB gz), `semiotic/utils` (21KB gz), `semiotic/recipes` (5KB gz), `semiotic/themes` (4KB gz), `semiotic/data` (3KB gz), `semiotic/ai` (181KB gz). Full `semiotic` is 180KB gz.
