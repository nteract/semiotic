...
**Use sub-path imports** — `semiotic/xy` (102KB gz), `semiotic/ordinal` (83KB gz), `semiotic/network` (88KB gz), `semiotic/geo` (64KB gz), `semiotic/realtime` (111KB gz), `semiotic/server` (186KB gz), `semiotic/utils` (60KB gz), `semiotic/recipes` (50KB gz), `semiotic/themes` (6KB gz), `semiotic/data` (4KB gz), `semiotic/value` (6KB gz), `semiotic/physics` (85KB gz), `semiotic/physics/matter` (1KB gz), `semiotic/physics/rapier` (1KB gz), `semiotic/ai` (385KB gz). Full `semiotic` is 296KB gz.
