...
**Use sub-path imports** — `semiotic/xy` (146KB gz), `semiotic/ordinal` (122KB gz), `semiotic/network` (146KB gz), `semiotic/geo` (104KB gz), `semiotic/realtime` (155KB gz), `semiotic/realtime/core` (146KB gz), `semiotic/realtime/react` (1KB gz), `semiotic/server` (226KB gz), `semiotic/server/node` (226KB gz), `semiotic/server/edge` (241KB gz), `semiotic/utils` (86KB gz), `semiotic/utils/core` (84KB gz), `semiotic/utils/react` (6KB gz), `semiotic/recipes` (90KB gz), `semiotic/recipes/core` (89KB gz), `semiotic/recipes/react` (2KB gz), `semiotic/themes` (7KB gz), `semiotic/themes/core` (7KB gz), `semiotic/themes/react` (6KB gz), `semiotic/data` (4KB gz), `semiotic/value` (8KB gz), `semiotic/physics` (161KB gz), `semiotic/physics/matter` (1KB gz), `semiotic/physics/rapier` (1KB gz), `semiotic/ai` (507KB gz), `semiotic/ai/core` (81KB gz), `semiotic/controls` (12KB gz), `semiotic/rough` (4KB gz). Full `semiotic` is 410KB gz.
