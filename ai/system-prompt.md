...
**Use sub-path imports** — `semiotic/xy` (98KB gz), `semiotic/ordinal` (79KB gz), `semiotic/network` (84KB gz), `semiotic/geo` (61KB gz), `semiotic/realtime` (107KB gz), `semiotic/server` (182KB gz), `semiotic/utils` (71KB gz), `semiotic/recipes` (48KB gz), `semiotic/themes` (6KB gz), `semiotic/data` (3KB gz), `semiotic/value` (6KB gz), `semiotic/physics` (83KB gz), `semiotic/physics/matter` (1KB gz), `semiotic/physics/rapier` (1KB gz), `semiotic/ai` (384KB gz). Full `semiotic` is 250KB gz.
