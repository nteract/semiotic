...
**Use sub-path imports** — `semiotic/xy` (100KB gz), `semiotic/ordinal` (81KB gz), `semiotic/network` (85KB gz), `semiotic/geo` (62KB gz), `semiotic/realtime` (110KB gz), `semiotic/realtime/core` (109KB gz), `semiotic/realtime/react` (1KB gz), `semiotic/server` (186KB gz), `semiotic/server/node` (186KB gz), `semiotic/server/edge` (185KB gz), `semiotic/utils` (71KB gz), `semiotic/utils/core` (70KB gz), `semiotic/utils/react` (4KB gz), `semiotic/recipes` (53KB gz), `semiotic/recipes/core` (52KB gz), `semiotic/recipes/react` (1KB gz), `semiotic/themes` (6KB gz), `semiotic/themes/core` (6KB gz), `semiotic/themes/react` (4KB gz), `semiotic/data` (3KB gz), `semiotic/value` (6KB gz), `semiotic/physics` (97KB gz), `semiotic/physics/matter` (1KB gz), `semiotic/physics/rapier` (1KB gz), `semiotic/ai` (391KB gz), `semiotic/ai/core` (77KB gz), `semiotic/controls` (5KB gz). Full `semiotic` is 256KB gz.
