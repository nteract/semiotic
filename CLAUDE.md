...
- **Use sub-path imports** — `semiotic/xy` (98KB gz), `semiotic/ordinal` (79KB gz), `semiotic/network` (83KB gz), `semiotic/geo` (60KB gz), `semiotic/realtime` (106KB gz), `semiotic/server` (134KB gz), `semiotic/utils` (39KB gz), `semiotic/recipes` (33KB gz), `semiotic/themes` (6KB gz), `semiotic/data` (4KB gz), `semiotic/value` (6KB gz), `semiotic/ai` (271KB gz). Full `semiotic` is 222KB gz.
