...
- **Use sub-path imports** — `semiotic/xy` (198KB gz), `semiotic/ordinal` (159KB gz), `semiotic/network` (150KB gz), `semiotic/geo` (116KB gz), `semiotic/realtime` (207KB gz), `semiotic/server` (159KB gz), `semiotic/utils` (39KB gz), `semiotic/recipes` (14KB gz), `semiotic/themes` (7KB gz), `semiotic/data` (6KB gz), `semiotic/ai` (412KB gz). Full `semiotic` is 414KB gz.
