...
- **Use sub-path imports** — `semiotic/xy` (102KB gz), `semiotic/ordinal` (83KB gz), `semiotic/network` (88KB gz), `semiotic/geo` (64KB gz), `semiotic/realtime` (111KB gz), `semiotic/server` (167KB gz), `semiotic/utils` (60KB gz), `semiotic/recipes` (45KB gz), `semiotic/themes` (6KB gz), `semiotic/data` (4KB gz), `semiotic/value` (6KB gz), `semiotic/physics` (107KB gz), `semiotic/physics/matter` (1KB gz), `semiotic/physics/rapier` (1KB gz), `semiotic/ai` (362KB gz). Full `semiotic` is 281KB gz.
