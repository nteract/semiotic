...
- **Use sub-path imports** — `semiotic/xy` (98KB gz), `semiotic/ordinal` (79KB gz), `semiotic/network` (80KB gz), `semiotic/geo` (60KB gz), `semiotic/realtime` (105KB gz), `semiotic/server` (133KB gz), `semiotic/utils` (39KB gz), `semiotic/recipes` (32KB gz), `semiotic/themes` (6KB gz), `semiotic/data` (4KB gz), `semiotic/value` (6KB gz), `semiotic/ai` (269KB gz). Full `semiotic` is 218KB gz.
