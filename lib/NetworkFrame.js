...
var networkFrame = function (_React$Component) {
  ...
  _createClass(networkFrame, [{
    ...
    value: function calculateNetworkFrame(currentProps) {
      ...
      var _currentProps$nodes = currentProps.nodes,
          nodes = _currentProps$nodes === undefined ? [] : _currentProps$nodes,
          _currentProps$edges = currentProps.edges,
          edges = _currentProps$edges === undefined ? [] : _currentProps$edges,
          _currentProps$network = currentProps.networkType,
          networkType = _currentProps$network === undefined ? { type: "force", iterations: 500 } : _currentProps$network,
          _currentProps$size = currentProps.size,
          size = _currentProps$size === undefined ? [500, 500] : _currentProps$size,
      ...
      var changedData = !this.state.projectedNodes || !this.state.projectedEdges || this.graphSettings.numberOfNodes !== (nodes ? nodes.length : undefined) || edges.length !== this.graphSettings.numberOfEdges;
      ...
      if (changedData) {
        ...
        nodes.forEach(function (node) {
          ...
          _this2.nodeHash.set(id, node);
          _this2.nodeHash.set(node, node);
        ...
        edges.forEach(function (edge) {
          ...
          if (!_this2.nodeHash.get(source)) {
            ...
            _this2.nodeHash.set(source, sourceNode);
            projectedNodes.push(sourceNode);
          }
          if (!_this2.nodeHash.get(target)) {
            ...
            _this2.nodeHash.set(target, targetNode);
            projectedNodes.push(targetNode);
          }
          var edgeWeight = edge.weight || 1;
          _this2.nodeHash.get(target).inDegree += edgeWeight;
          _this2.nodeHash.get(source).outDegree += edgeWeight;
          _this2.nodeHash.get(target).degree += edgeWeight;
          _this2.nodeHash.get(source).degree += edgeWeight;

          var edgeKey = (nodeIDAccessor(source) || source) + "|" + (nodeIDAccessor(target) || target);
          var newEdge = _extends({}, edge, {
            source: _this2.nodeHash.get(source),
            target: _this2.nodeHash.get(target)
          });
          _this2.edgeHash.set(edgeKey, newEdge);
        ...
        projectedEdges.forEach(function (edge) {
          ...
          _this2.edgeHash.set(edgeKey, edge);
        });
      }
      ...
      networkSettingsKeys.forEach(function (key) {
        if (key !== "edgeType" && networkSettings[key] !== _this2.graphSettings[key]) {
      ...
      if (changedData || networkSettingsChanged) {
        ...
        var components = (0, _graphologyComponents.connectedComponents)(graph).sort(function (a, b) {
          return b.length - a.length;
        });
        var strongComponents = (0, _graphologyComponents.stronglyConnectedComponents)(graph).sort(function (a, b) {
          return b.length - a.length;
        });
        ...
        if (networkSettings.type === "chord") {
          ...
          chords.forEach(function (chord) {
            ...
            var chordEdge = _this2.edgeHash.get(nodeSourceID + "|" + nodeTargetID);
            chordEdge.d = chordD;
          });
          ...
          var _simulation = (0, _d3Force.forceSimulation)().force("charge", (0, _d3Force.forceManyBody)().distanceMax(networkSettings.distanceMax || Infinity).strength(networkSettings.forceManyBody || function (d) {
          ...
          var largestComponent = Math.max(projectedNodes.length / 3, components[0].length);
          ...
          components.forEach(function (component) {
            var componentNodes = projectedNodes.filter(function (d) {
              return component.indexOf(nodeIDAccessor(d)) !== -1;
            });
            var componentEdges = projectedEdges.filter(function (d) {
              return component.indexOf(nodeIDAccessor(d.source)) !== -1 || component.indexOf(nodeIDAccessor(d.target)) !== -1;
            });
            ...
            var componentLayoutSize = Math.max(component.length / largestComponent, 0.2) * layoutSize;
      ...
      var networkFrameRender = {
        edges: {
          ...
          renderKeyFn: currentProps.edgeRenderKey ? currentProps.edgeRenderKey : function (d) {
            return nodeIDAccessor(d.source) + "-" + nodeIDAccessor(d.target);
          },
    ...
    value: function defaultNetworkSVGRule(_ref6) {
      var d = _ref6.d,
          i = _ref6.i;
    ...
    value: function defaultNetworkHTMLRule(_ref7) {
      var d = _ref7.d,
          i = _ref7.i;
    ...
    key: "renderBody",
    value: function renderBody(_ref8) {
      var afterElements = _ref8.afterElements;
      ...
      var _state3 = this.state,
          ...
          _state3$nodeLabelAnno = _state3.nodeLabelAnnotations,
          nodeLabelAnnotations = _state3$nodeLabelAnno === undefined ? [] : _state3$nodeLabelAnno;
