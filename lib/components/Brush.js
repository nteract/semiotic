...
var Brush = function (_React$Component) {
    ...
    _createClass(Brush, [{
        ...
        value: function createBrush() {
            ...
            (0, _d3Selection.select)(node).selectAll("rect").attr("height", this.props.size[1]);

            (0, _d3Selection.select)(node).selectAll("g.resize > rect").style("visibility", "visible");
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement('g', { ref: function ref(node) {
                ...
                }, transform: "translate(" + (this.props.position || [0, 0]) + ")", className: 'xybrush' });
        }
    }]);
