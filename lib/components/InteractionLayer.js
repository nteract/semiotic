...
var InteractionLayer = function (_React$Component) {
    ...
    _createClass(InteractionLayer, [{
        ...
        value: function createBrush() {
            ...
            */
            abacusBrush.extent([[this.props.margin.left, this.props.margin.top], [this.props.size[0] + this.props.margin.left, this.props.size[1] + this.props.margin.top]]).on("start", function () {
            ...
            return _react2.default.createElement(_Brush2.default, { selectedExtent: selectedExtent, svgBrush: abacusBrush, size: this.props.size });
        }
    }, {
        ...
        value: function createColumnsBrush() {
            ...
            var brushes = Object.keys(columnHash).map(function (c) {
                abacusBrush = (0, _d3Brush.brushY)();
                abacusBrush.extent([[0, rRange[0]], [columnHash[c].width, rRange[1]]]).on("start", function () {
                ...
                return _react2.default.createElement(_Brush2.default, { position: [columnHash[c].x, 0], key: "orbrush" + c, selectedExtent: selectedExtent, svgBrush: abacusBrush, size: _this3.props.size });
            });
            return brushes;
        }
    }, {
