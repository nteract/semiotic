...
var DividedLine = function (_React$Component) {
  ...
  _createClass(DividedLine, [{
    ...
    value: function createLineSegments() {
      ...
      var data = (0, _lineDrawing.projectLineData)({ data: this.props.data, lineDataAccessor: this.props.lineDataAccessor, xProp: "_x", yProp: "_y", xAccessor: this.props.customAccessors.x, yAccessor: this.props.customAccessors.y });
      ...
      return lines.map(function (d, i) {
        return _react2.default.createElement(_Mark2.default, _extends({}, _this2.props, { className: className, markType: 'path', key: "DividedLine" + i, style: d.key, d: lineRender(d.points) }));
      });
    }
  }, {
    key: 'render',
