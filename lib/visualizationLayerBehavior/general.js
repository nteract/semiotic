...
function createLines(_ref3) {
  ...
  if (customLine.type === "difference" && lineData.length === 2) {
    ...
    var diffdata = lineData[0];
    var doClassname = props.lineClass ? "xyframe-line " + props.lineClass(diffdata) : "xyframe-line";
    ...
    var baseStyle = props.lineStyle ? props.lineStyle(diffdata, 0) : {};
    var diffOverlay = _react2.default.createElement(_Mark2.default, { key: "xyline-diff", className: doClassname, markType: 'path', d: overLine(diffdata.data), style: _extends(baseStyle, { fill: "none", pointerEvents: "none" }) });
