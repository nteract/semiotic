...
function createLines(_ref3) {
  ...
  if (customLine.type === "difference" && data.length === 2) {
    ...
    var diffOverlayA = _react2.default.createElement(_Mark2.default, {
      key: "xyline-diff-a",
    ...
    var diffOverlayB = _react2.default.createElement(_Mark2.default, {
      key: "xyline-diff-b",
...
function createAreas(_ref4) {
  ...
  data.forEach(function (d, i) {
    ...
    if (canvasRender && canvasRender(d, i) === true) {
      ...
      renderedAreas.push(_react2.default.createElement(_Mark2.default, {
        key: renderKey,
        forceUpdate: true,
