...
function relativeY(_ref7) {
  var point = _ref7.point,
      lines = _ref7.lines,
      projectedYMiddle = _ref7.projectedYMiddle,
      projectedY = _ref7.projectedY,
      projectedX = _ref7.projectedX,
  ...
  if (idAccessor(point)) {
    var thisLine = lines.find(function (l) {
