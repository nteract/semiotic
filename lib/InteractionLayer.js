  ...
  _createClass(InteractionLayer, [{
    ...
    value: function calculateOverlay(props) {
      ...
      if (points && props.hoverAnnotation && !overlay) {
        var voronoiDiagram = (0, _d3Voronoi.voronoi)().extent([[margin.left, margin.top], [size[0] + margin.left, size[1] + margin.top]]).x(function (d) {
        ...
        points.forEach(function (d) {
          ...
          if (xValue && yValue && isNaN(xValue) === false && isNaN(yValue) === false) {
            ...
            if (!voronoiUniqueHash[pointKey]) {
              var voronoiPoint = _extends(d, { coincidentPoints: [d] });
        ...
        voronoiPaths = voronoiData.map(function (d, i) {
          return _react2.default.createElement("path", {
            ...
            onMouseEnter: function onMouseEnter() {
              _this3.changeVoronoi(voronoiDataset[i]);
            },
        ...
        var renderedOverlay = overlay.map(function (overlayRegion) {
          return _react2.default.createElement(_Mark2.default, _extends({}, overlayRegion, {
            onClick: function onClick() {
            ...
            onMouseEnter: function onMouseEnter() {
              _this3.changeVoronoi(overlayRegion.onMouseEnter());
            },
            onMouseLeave: function onMouseLeave() {
              _this3.changeVoronoi();
            }
