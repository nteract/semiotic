...
- **HOC boilerplate reduction: imperative-handle helper + alias destructure** — Two cross-cutting passes against the 38 published HOCs; net 35 files changed, 624 deletions vs 165 insertions (≈460 lines off the HOC surface).
