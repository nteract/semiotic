...
export const NETWORK_CHART_SPECS: Record<string, ChartSpec> = {
  ...
  ProcessSankey: {
    ...
    ownProps: {
      ...
      domain: { type: "array", description: "[tStart, tEnd] of the time axis (required). Numbers and numeric strings use numeric units; Date/ISO values use UTC dates. ISO datetimes without a zone mean UTC." },
      axisTicks: { type: "array", description: "Override automatic time-axis ticks with [{ date, label? }]. An empty array hides ticks." },
      sourceAccessor: { type: ["string", "function"], default: "source" },
      targetAccessor: { type: ["string", "function"], default: "target" },
      ...
      onLayoutStateChange: { type: "function", omitFromSchema: true },
      timeFormat: { type: "function", omitFromSchema: true, description: "Formats axis and tooltip times; receives numbers for numeric domains and Dates for Date/ISO domains." },
