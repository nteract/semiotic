...
export const VALIDATION_MAP: Record<string, ComponentSpec> = {
  ...
  NetworkHOPsChart: {
    ...
    props: {
      ...
      sourceAccessor: { type: ["string", "function"] },
      targetAccessor: { type: ["string", "function"] },
      edgeProbabilityAccessor: { type: ["string", "function"] },
      sampleIndex: { type: "number" },
      sampleRate: { type: "number" },
      paused: { type: "boolean" },
      seed: { type: "number" },
      anchoringStrength: { type: "number" },
      showAggregate: { type: "boolean" },
      showSampleReadout: { type: "boolean" },
      activeEdgeColor: { type: "string" },
      activeEdgeOpacity: { type: "number" },
      aggregateEdgeColor: { type: "string" },
      aggregateEdgeOpacity: { type: "number" },
      aggregateEdgeWidth: { type: "number" },
      edgeWidth: { type: ["number", "string", "function"] },
      edgeColor: { type: "string" },
      iterations: { type: "number" },
      nodeLabel: { type: ["string", "function"] },
      ...
      nodeSizeRange: { type: "array" },
      showLabels: { type: "boolean" },
      layoutExecution: { type: "string", enum: ["auto", "worker", "sync"] as const },
    },
  },
  PhysicalFlowChart: {
    required: [],
