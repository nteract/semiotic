...
const commonProps: Record<string, PropDef> = {
  ...
  mobileSemantics: { type: "object" },
  mobileInteraction: { type: ["boolean", "object"] },
  axisExtent: { type: "string", enum: ["nice", "exact"] as const },
...
const physicsProps: Record<string, PropDef> = {
  data: { type: "array" },
  size: { type: "array" },
  width: { type: "number" },
  height: { type: "number" },
...
export const VALIDATION_MAP: Record<string, ComponentSpec> = {
  ...
  DifferenceChart: {
    // Push mode supported — `data` is optional, validation triggers only
    // when the static path is in use (same pattern as AreaChart).
    required: [],
    dataShape: "array",
    ...
    props: {
      ...
      data: { type: "array" },
      xAccessor: { type: ["string", "function"] },
      seriesAAccessor: { type: ["string", "function"] },
      seriesBAccessor: { type: ["string", "function"] },
      seriesALabel: { type: "string" },
      seriesBLabel: { type: "string" },
      seriesAColor: { type: "string" },
      seriesBColor: { type: "string" },
  ...
  Scatterplot: {
    ...
    props: {
      ...
      symbolBy: { type: ["string", "function"] },
      symbolMap: { type: "object" },
      pointRadius: { type: "number" },
  ...
  GaugeChart: {
    ...
    props: {
      ...
      gradientFill: { type: "object" },
      arcWidth: { type: "number" },
      cornerRadius: { type: "number" },
      sweep: { type: "number" },
      fillZones: { type: "boolean" },
  ...
  ProcessSankey: {
    ...
    props: {
      ...
      edges: { type: "array" },
      domain: { type: "array" },
      axisTicks: { type: "array" },
      sourceAccessor: { type: ["string", "function"] },
      targetAccessor: { type: ["string", "function"] },
      valueAccessor: { type: ["string", "function"] },
      nodeIdAccessor: { type: ["string", "function"] },
      startTimeAccessor: { type: ["string", "function"] },
      endTimeAccessor: { type: ["string", "function"] },
      xExtentAccessor: { type: ["string", "function"] },
      edgeIdAccessor: { type: ["string", "function"] },
      legendPosition: { type: "string", enum: ["right", "left", "top", "bottom"] },
      pairing: { type: "string", enum: ["value", "temporal"] },
      packing: { type: "string", enum: ["off", "reuse"] },
      laneOrder: { type: "string", enum: ["insertion", "crossing-min", "inside-out", "crossing-min+inside-out"] },
      ribbonLane: { type: "string", enum: ["source", "target", "both"] },
      lifetimeMode: { type: "string", enum: ["full", "half"] },
      showLaneRails: { type: "boolean" },
      showQualityReadout: { type: "boolean" },
      edgeOpacity: { type: "number" },
  ...
  RealtimeHistogram: {
    ...
    props: {
      ...
      strokeWidth: { type: "number" },
      gap: { type: "number" },
      brush: { type: ["boolean", "string", "object"] },
      onBrush: { type: "function" },
      linkedBrush: { type: ["string", "object"] },
      timeExtent: { type: "array" },
      valueExtent: { type: "array" },
  ...
  PhysicsPileChart: {
    ...
    props: {
      ...
      mode: { type: "string", enum: ["sample", "mechanical"] },
      mechanicalCount: { type: "number" },
      mechanicalCategories: { type: "array" },
  ...
  CollisionSwarmChart: {
    ...
    props: {
      ...physicsProps,
      xAccessor: { type: ["string", "function"] },
      groupAccessor: { type: ["string", "function"] },
      radiusAccessor: { type: ["string", "function"] },
      pointRadius: { type: "number" },
      xExtent: { type: "array" },
      collisionIterations: { type: "number" },
      settle: { type: "boolean" },
      showProjection: { type: "boolean" },
    },
  },
  ProcessFlowChart: {
    ...
    props: {
      ...physicsProps,
      stages: { type: "array" },
      stageAccessor: { type: ["string", "function"] },
      idAccessor: { type: ["string", "function"] },
      groupBy: { type: ["string", "function"] },
      groupLabelAccessor: { type: ["string", "function"] },
      workAccessor: { type: ["string", "function"] },
      radiusAccessor: { type: ["string", "function"] },
      ballRadius: { type: "number" },
      groupCompletion: { type: "string", enum: ["allAbsorbed", "none"] },
      groupAnchorAlong: { type: "number" },
      showProjection: { type: "boolean" },
  ...
  GauntletChart: {
    ...
    props: {
      ...physicsProps,
      positiveProperties: { type: "array" },
      negativeProperties: { type: "array" },
      gates: { type: "array" },
      events: { type: ["array", "function"] },
      showChrome: { type: "boolean" },
      showProjection: { type: "boolean" },
      showTethers: { type: "boolean" },
      terminalBehavior: { type: "string", enum: ["outcome", "hold-last"] },
    },
  },
  PhysicalFlowChart: {
    required: [],
    ...
    props: {
      ...
      data: { type: "array" },
      nodeIdAccessor: { type: ["string", "function"] },
      nodeXAccessor: { type: ["string", "function"] },
      nodeYAccessor: { type: ["string", "function"] },
      sourceAccessor: { type: ["string", "function"] },
      targetAccessor: { type: ["string", "function"] },
      throughputAccessor: { type: ["string", "function"] },
      pathAccessor: { type: ["string", "function"] },
      coordinateMode: { type: "string", enum: ["auto", "normalized", "pixels"] as const },
      particleRate: { type: "number" },
      maxParticles: { type: "number" },
      particleRadius: { type: "number" },
      flowSpeed: { type: "number" },
      pathConstraint: { type: "string", enum: ["path", "none"] as const },
      reducedMotion: { type: "boolean" },
      showStaticFlow: { type: "boolean" },
      showNodeLabels: { type: "boolean" },
      showSensors: { type: "boolean" },
      paused: { type: "boolean" },
      seed: { type: "number" },
    },
  },
