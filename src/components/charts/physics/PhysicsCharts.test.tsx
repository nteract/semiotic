...
describe("physics chart HOCs", () => {
  ...
  it("places positive gauntlet properties above the core and negatives below it", () => {
  ...
  it("net Gauntlet core force raises positive-heavy projects and sinks negative-heavy projects", () => {
