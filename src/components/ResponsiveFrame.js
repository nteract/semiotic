...
const createResponsiveFrame = (Frame) => {
  ...
  return Dimensions()(class ResponsiveFrame extends React.Component {
    render () {
 
      const { responsiveWidth, responsiveHeight, size, 
        containerHeight, containerWidth, dataVersion } = this.props
