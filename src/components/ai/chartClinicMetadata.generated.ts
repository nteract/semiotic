...
export const CHART_CLINIC_METADATA: Readonly<Record<string, ChartClinicMetadata>> = {
  ...
  "RadarChart": {"category":"ordinal","recommendedImport":"semiotic/ordinal","serverImport":"semiotic/server"},
  ...
  "LineChart": {"category":"xy","recommendedImport":"semiotic/line","serverImport":"semiotic/server","docsRoute":"/charts/line-chart","pilot":true},
  ...
  "MultiAxisLineChart": {"category":"xy","recommendedImport":"semiotic/xy","serverImport":"semiotic/server"},
  ...
  "RealtimeWaterfallChart": {"category":"realtime","recommendedImport":"semiotic/realtime","serverImport":"semiotic/server"},
  "RealtimeHeatmap": {"category":"realtime","recommendedImport":"semiotic/realtime","serverImport":"semiotic/server"},
