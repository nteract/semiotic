...
/** The optional codec stays outside the synchronous SVG entry graph. */
async function encodeSvgFramesToGif(...args: Parameters<typeof import("./encodeSvgFramesToGif").encodeSvgFramesToGif>): Promise<Buffer> {
  const codec = await import("./encodeSvgFramesToGif")
  return codec.encodeSvgFramesToGif(...args)
}
