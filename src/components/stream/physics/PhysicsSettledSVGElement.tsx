...
export interface PhysicsSettledSVGElementRender {
...
/**
 * Builds the settled SVG as a React element without importing ReactDOM.
 * StreamPhysicsFrame uses this path during SSR so browser charts do not pull
 * a static-markup renderer into their runtime bundle.
 */
export function createPhysicsSettledSVG(
  store: PhysicsPipelineStore,
  options: PhysicsSettledSVGOptions = {}
): PhysicsSettledSVGElementRender {
  const {
    width = 640,
    height = 360,
    title,
