    ...
    <g id="_KC_-_7">
      <g id="Compass_copy_5">
        <g id="Compass_8_">
          <polygon
            className="st0"
            points="232.8,206.4 225.7,200.5 221.8,193.5 228.2,198.4 			"
          />
          <path
            className="st1"
            d="M237.2,211.2c-6.4,5.6-16.3,4.9-21.9-1.5c-5.6-6.4-4.9-16.3,1.5-21.9c6.4-5.6,16.3-4.9,21.9,1.5 C244.3,195.8,243.7,205.6,237.2,211.2z M217.7,188.8c-5.9,5.1-6.5,14.1-1.4,20c5.1,5.9,14.1,6.5,20,1.4c5.9-5.1,6.5-14.1,1.4-20 C232.6,184.3,223.6,183.7,217.7,188.8z"
          />

          <ellipse
            transform="matrix(6.873409e-02 -0.9976 0.9976 6.873409e-02 12.3665 412.2869)"
            className="st0"
            cx="227"
            cy="199.5"
            rx="3"
          ...
          <g>
            <path
              className="st0"
              d="M220,193.3l-2-2.3l0.4-0.3l2.5,0.7l0,0l-1.4-1.6l0.4-0.3l2,2.3l-0.4,0.3l-2.5-0.7l0,0l1.4,1.6L220,193.3z"
            />
          </g>

          <ellipse
            transform="matrix(6.871367e-02 -0.9976 0.9976 6.871367e-02 12.3709 412.2913)"
            className="st2"
            cx="227"
            cy="199.5"
            rx="1.6"
      ...
      />
      <text transform="matrix(1 0 0 1 9.2153 82.7325)" className="st4 st6 st7">
        330
      </text>
      <text
        transform="matrix(1 0 0 1 116.7671 25.1924)"
        className="st4 st6 st7"
      >
        410
      </text>
      <text transform="matrix(1 0 0 1 56.4336 44.5264)" className="st4 st6 st7">
        385
      </text>
      <text
        transform="matrix(1 0 0 1 176.1948 44.5254)"
        className="st4 st6 st7"
      >
        385
      </text>
      <text
        transform="matrix(1 0 0 1 222.2173 82.7325)"
        className="st4 st6 st7"
      >
        330
      </text>
