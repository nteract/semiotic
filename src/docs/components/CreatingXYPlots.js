      ...
      demo: (
        <div>
          <p>
            ...
            or yAccessor). The parentArea has the same basic properties you pass
            but you can inspect the _baseData property to get access to the data
            generated by the areaDataAccessor.
          </p>
          <XYFrame
            areas={[{ coordinates: pointTestData }]}
            areaDataAccessor={[
