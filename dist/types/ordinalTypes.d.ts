...
import { CanvasPostProcessTypes, ProjectionTypes, accessorType, GenericObject, OrdinalSummaryTypeSettings, RoughType } from "./generalTypes";
...
import { MarginType, GenericAccessor, RenderPipelineType } from "./generalTypes";
...
declare type PieceTypes = "none" | "bar" | "clusterbar" | "point" | "swarm" | "timeline" | "barpercent";
export declare type PieceTypeSettings = {
    type: PieceTypes;
    offsetAngle?: number;
    angleRange?: number[];
};
export declare type ProjectedOrdinalSummary = {
    originalData?: {
        x?: number;
        y?: number;
    };
...
export declare type OrdinalFrameProps = {
...
export declare type OrdinalFrameState = {
    dataVersion?: string;
